...
class Item {
    ...
    public function divide(array $attributes = array()){
        ...
        $attributes['class'] = Builder::formatGroupClass(array('class' => 'divider'), $attributes);
    ...
    {
        $children = $this->builder->whereParent($this->id);
        $children[sizeof($children)-1]->isLastChild = true;
